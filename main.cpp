        ...
        if (gui->glow) {
            ...
            for (int i = 0; i < 64; ++i) {
                ...
                if (entity != NULL) {
                    ...
                    // Set glow on
                    if (!gui->teamGlow && localTeam == entityTeam) {
